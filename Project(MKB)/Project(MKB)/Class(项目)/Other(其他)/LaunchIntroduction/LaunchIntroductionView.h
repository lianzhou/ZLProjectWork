...
/**
 ...
 @param gifArray 格式 gifArray = @[@[@"png0",@"png1"],@[@"png0",@"png1"],@[@"png0",@"png1"]];
 @param buttonImageName string
 @param frame <#frame description#>
 @return <#return value description#>
 */
+(instancetype)sharedWithGifArray:(NSArray *)gifArray buttonImage:(NSString *)buttonImageName buttonFrame:(CGRect)frame;
