...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/ZLCommonsKit/ZLEmojiExpression.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/ZLCommonsKit/ENImagePickerExpression.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/ZLCommonsKit/ZLPlaceholderExp.bundle"
fi
